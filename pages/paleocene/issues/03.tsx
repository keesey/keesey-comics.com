    ...
    <>
      ...
      >
        ...
        <ComicStrip>
          ...
          <ImagePanel
            height={280}
            src="/images/issues/paleocene/03/01.png"
            width={310}
          />
          <TextPanel emphatic>
            ...the Fire-Quake, the Rising Sea, the Storm of Stones.
          </TextPanel>
          <ImagePanel
            height={280}
            src="/images/issues/paleocene/03/02.png"
            width={284}
          />
          <TextPanel emphatic>
            it left a Shroud above our Heads that slew the Sun, and lay my
            northern Province bare.
          </TextPanel>
          <ImagePanel
            height={280}
            src="/images/issues/paleocene/03/03.png"
            width={380}
          />
          <TextPanel emphatic>
            in lonely Stillness, Signs of Life cannot be found, save where, in
            Silt turned hard as Stone...
          </TextPanel>
          <ImagePanel
            height={280}
            src="/images/issues/paleocene/03/04.png"
            width={286}
          />
