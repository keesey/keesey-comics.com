    ...
    <>
      ...
      >
        ...
        <Quotes
          quotes={[
            {
              attribution: <>Madeleine Holly-Rosing, <cite>Fanbase Press</cite></>,
        ...
        <ComicStrip>
          <TextPanel>
            Sister has been taken from the nest by ... something.
          </TextPanel>
          <ImagePanel
            height={280}
            src="/images/issues/paleocene/02/01.png"
            width={189}
          />
          <TextPanel>Was it really a Hunter, as Brother says?</TextPanel>
          <ImagePanel
            height={280}
            src="/images/issues/paleocene/02/02.png"
            width={162}
          />
          <TextPanel>Will the troop believe his story?</TextPanel>
          <ImagePanel
            height={280}
            src="/images/issues/paleocene/02/03.png"
            width={380}
          />
          <TextPanel>What really happened to her?</TextPanel>
          <ImagePanel
            height={280}
            src="/images/issues/paleocene/02/04.png"
            width={240}
          />
        </ComicStrip>
