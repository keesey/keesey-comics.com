...
import { THE_FLESH_01, THE_FLESH_01_ABSTRACT_HTML } from "./schema"
export const metadata: Metadata = {
  ...generateCreativeWorkMetadata(THE_FLESH_01),
  alternates: { canonical: "/comics/the-flesh/issues/01" },
  openGraph: { siteName: "Keesey Comics", url: "/comics/the-flesh/issues/01" },
}
export default function TheFlesh01() {
  return (
    <>
      <Schema thing={THE_FLESH_01} />
      <Breadcrumbs
        crumbs={createCrumbsForIssue("The Flesh", "/comics/the-flesh", 1)}
      />
      <SectionsContainer>
        <CreativeWorkSections
          subject={THE_FLESH_01}
          abstractHTML={THE_FLESH_01_ABSTRACT_HTML}
          creator={GAGE_ULLMAN}
        >
          <ProductDetailsSection>
            ...
            <Definition>{String(THE_FLESH_01.copyrightYear)}</Definition>
        ...
        <EditionsSection>
          <EditionSection title="Print Edition">
            ...
            <AddToCartCTA productIds={["COB-ST2-FLE-01A"]} href="/cart" />
            <Link href="/contact">
