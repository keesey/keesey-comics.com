...
export type RemoveProductAction = FSAWithPayload<
  "REMOVE_PRODUCT",
  Pick<OrderItem, "productId">
>;
export type SetQuantityAction = FSAWithPayload<
  "SET_QUANTITY",
  Pick<OrderItem, "productId" | "quantity">
>;
export type IncrementQuantityAction = FSAWithPayload<
  "INCREMENT_QUANTITY",
  Pick<OrderItem, "productId">
>;
