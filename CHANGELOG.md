...
## [3.4.1](https://github.com/keesey/keesey-comics.com/tree/v3.4.1) - 2026-08-05

### Added

- Home Page Carousel item for _Where Are My Dang Spaceship Keys?_.

### Fixed

- Added `sizes` props for images.

## [3.4.0](https://github.com/keesey/keesey-comics.com/tree/v3.4.0) - 2026-08-05

### Added

- New page for _Where Are My Dang Spaceship Keys?_, with links in All Comics Aside and Comics Page.

### Security

- Upgrades for `postcss` and `fast-uri`.

## [3.3.7](https://github.com/keesey/keesey-comics.com/tree/v3.3.7) - 2026-07-22
...
- Upgraded certain dependencies, including an upgrade to Next.js `v16.1.5`.
...
- Patch upgrades for Next.js, Storybook, `js-yaml`, and `qs`.
...
- IDs to Google Analytics `<script>` elements.

## [3.1.0](https://github.com/keesey/keesey-comics.com/tree/v3.1.0) - 2025-10-07
